           ...
           forKey:(NSString *)key
{
    ...
    NSKeyedArchiverExt *keyedArchiver =
        [[NSKeyedArchiverExt alloc] initForWritingWithMutableData:data];
...
- (id)getObjectForKey:(NSString *)key
{
    ...
    NSKeyedUnarchiverExt *keyedUnarchiver =
        [[NSKeyedUnarchiverExt alloc] initForReadingWithData:data];
